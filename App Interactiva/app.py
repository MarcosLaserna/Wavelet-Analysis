...
if active_tab == "1. Arquetipoides":
    ...
    with col1:
        ...
        st.caption(
            "Cada punto es un activo situado en el h-plot de distancias wavelet. "
            "Los circulos grandes con borde negro son los arquetipoides reales "
            "seleccionados como vertices del simplex."
        )
